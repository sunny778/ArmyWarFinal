...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleApiClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(MainActivity.this, "Google connection is failed", Toast.LENGTH_SHORT).show();
                    }
                })
        ...
        findViewById(R.id.buttonFirebaseSignIn).setOnClickListener(this);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(MainActivity.this, "Create user was failed - " + task.getException(), Toast.LENGTH_SHORT).show();
                        }else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "Sign in was failed - " + task.getException(), Toast.LENGTH_SHORT).show();
                        }else{
                            Intent intent = new Intent(MainActivity.this, UserMainPageActivity.class);
                            startActivity(intent);
                        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.buttonFirebaseSignIn:
